% Static force analysis of a balloon rigging (Design CliffB)
...
b=6; s=14; m=b+s                        % Connectivity matrix
...
C(19,3)=1; C(19,7)=-1;             % strings from payload to ground
C(20,1)=1; C(20,8)=-1;             % strings from payload to ground
